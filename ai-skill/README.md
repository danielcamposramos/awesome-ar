...
- **Claude Code or Claude.ai:** `SKILL.md` carries the usual frontmatter, so drop this folder into your skills directory and it loads as `awesome-ar-contributing`.
